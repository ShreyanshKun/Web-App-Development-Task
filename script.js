...
function renderCalendar() {                     //  function to Render horizontal calendar
...
function setupModalButton() {                                   // function to open pop up
...
function loadTaskForDate(date) {                                    // function to load tasks for selected date
